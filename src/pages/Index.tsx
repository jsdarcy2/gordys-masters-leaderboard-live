    ...
    <Layout>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <Link to="/leaderboard" className="block h-full no-underline">
          <Card className="h-full border bg-gradient-to-br from-white/90 to-white/90 border-masters-green/20 hover:border-masters-green/40 shadow-card hover:shadow-elegant transition-all duration-300 cursor-pointer relative overflow-hidden">
        ...
        <Link to="/selections" className="block h-full no-underline">
          <Card className="h-full border bg-gradient-to-br from-masters-gold/20 to-masters-lightgold/40 border-masters-gold/30 hover:border-masters-gold/60 shadow-card hover:shadow-elegant transition-all duration-300 cursor-pointer relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none">
              <img 
                src="/lovable-uploads/da04fdbb-1d5b-4ccc-88b2-56a6c6f96db5.png" 
                alt=""
