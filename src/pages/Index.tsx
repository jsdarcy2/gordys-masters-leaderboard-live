    ...
    <Layout>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="h-full">
          <Link to="/leaderboard" className="block h-full no-underline">
            <Card className="h-full border bg-gradient-to-br from-white/90 to-white/90 border-masters-green/20 hover:border-masters-green/40 shadow-card hover:shadow-elegant transition-all duration-300 cursor-pointer">
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="mt-3 flex items-center justify-between text-masters-green group-hover:text-masters-green text-sm font-medium">
        ...
        <div className="h-full">
          <Link to="/selections" className="block h-full no-underline">
            <Card className="h-full border bg-gradient-to-br from-masters-gold/20 to-masters-lightgold/40 border-masters-gold/30 hover:border-masters-gold/60 shadow-card hover:shadow-elegant transition-all duration-300 cursor-pointer">
              <div className="absolute inset-0 pointer-events-none">
                <img 
                  src="/lovable-uploads/da04fdbb-1d5b-4ccc-88b2-56a6c6f96db5.png" 
                  alt=""
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="mt-3 flex items-center justify-between text-masters-darkgreen group-hover:text-masters-darkgreen text-sm font-medium">
                  <span className="font-serif">View details</span>
                  <ChevronRight 
                    size={18} 
                    className="transform transition-transform duration-300 group-hover:translate-x-1" 
        ...
        <div className="h-full">
          <Link to="/archive" className="block h-full no-underline">
            <Card className="h-full border bg-gradient-to-br from-white/90 to-white/90 border-masters-green/20 hover:border-masters-green/40 shadow-card hover:shadow-elegant transition-all duration-300 cursor-pointer">
              <div className="absolute inset-0 pointer-events-none">
                <img 
                  src="/lovable-uploads/da04fdbb-1d5b-4ccc-88b2-56a6c6f96db5.png" 
