 ...
 */
const validateLeaderboardData = (data: any): boolean => {
 ...
 */
const buildGolferScoreMap = (leaderboard: GolferScore[]): Record<string, number> => {
 ...
 */
const generateParticipantName = (index: number): string => {
  const firstNames = [
